...
if (existsSync("./.iiif/build/meta/search/manifests.schema.json")) {
  const schema = await Bun.file("./.iiif/build/meta/search/manifests.schema.json").json();
  const data = await Bun.file("./.iiif/build/meta/search/manifests.jsonl").text();
...
if (existsSync("./.iiif/build/meta/search/manifest-plaintext.schema.json")) {
  const schema = await Bun.file("./.iiif/build/meta/search/manifest-plaintext.schema.json").json();
  const data = await Bun.file("./.iiif/build/meta/search/manifest-plaintext.jsonl").text();
